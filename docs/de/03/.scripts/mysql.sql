...
CREATE TABLE public.friend_graph
(
    player_id_1 INT,
    player_id_2 INT,
    ...
    CONSTRAINT friend_graph_player_player_id_1_id_fk
        FOREIGN KEY (player_id_1) REFERENCES public.player (id),
    CONSTRAINT friend_graph_player_player_id_2_id_fk
        FOREIGN KEY (player_id_2) REFERENCES public.player (id)
);
...
CREATE UNIQUE INDEX player_name_uindex ON player((SUBSTRING(lower(player_name), 1, 50)));
